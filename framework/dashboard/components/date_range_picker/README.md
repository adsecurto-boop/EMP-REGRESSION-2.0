# Component Object -- `date_range_picker`

Folder scaffold only. Date-range control, repeated on screenshots, recordings, timesheet, reports. Range interpretation timezone is an open question (Navigation spec section 6).
