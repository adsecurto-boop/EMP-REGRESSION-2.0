"""EM011_ScreenRecording -- Screen Recording validation plugin.

Validates the EmpMonitor Screen Recording feature across configuration (L1), runtime
...
class ScreenRecordingPlugin(FeatureValidationPlugin):
    """Validates the EmpMonitor Screen Recording feature.

    Inherits every default from :class:`~plugins.base.FeatureValidationPlugin`.
    """

    feature_id = "EM011_ScreenRecording"
    ...
    def feature_summary(self) -> Mapping[str, Any]:
        """Return detail specific to Screen Recording.
