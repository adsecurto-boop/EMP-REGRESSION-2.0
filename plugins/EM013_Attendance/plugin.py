"""EM013_Attendance -- Attendance validation plugin.

Validates the EmpMonitor Attendance feature across configuration (L1), runtime
...
* APIs: none recorded
* dashboard pages: timesheet, reports
...
class AttendancePlugin(FeatureValidationPlugin):
    """Validates the EmpMonitor Attendance feature.

    Inherits every default from :class:`~plugins.base.FeatureValidationPlugin`.
    """

    feature_id = "EM013_Attendance"
    ...
    def feature_summary(self) -> Mapping[str, Any]:
        """Return detail specific to Attendance.
