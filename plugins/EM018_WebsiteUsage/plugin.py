"""EM018_WebsiteUsage -- Website Usage validation plugin.

Validates the EmpMonitor Website Usage feature across configuration (L1), runtime
...
class WebsiteUsagePlugin(FeatureValidationPlugin):
    """Validates the EmpMonitor Website Usage feature.

    Inherits every default from :class:`~plugins.base.FeatureValidationPlugin`.
    """

    feature_id = "EM018_WebsiteUsage"
    ...
    def feature_summary(self) -> Mapping[str, Any]:
        """Return detail specific to Website Usage.
