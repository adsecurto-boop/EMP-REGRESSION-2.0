"""EM019_UsbDetection -- USB Detection validation plugin.

Validates the EmpMonitor USB Detection feature across configuration (L1), runtime
...
__all__ = ["UsbDetectionPlugin"]


class UsbDetectionPlugin(FeatureValidationPlugin):
    """Validates the EmpMonitor USB Detection feature.

    Inherits every default from :class:`~plugins.base.FeatureValidationPlugin`.
    """

    feature_id = "EM019_UsbDetection"
    ...
    def feature_summary(self) -> Mapping[str, Any]:
        """Return detail specific to USB Detection.
