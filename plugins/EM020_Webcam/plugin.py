"""EM020_Webcam -- Webcam validation plugin.

Validates the EmpMonitor Webcam feature across configuration (L1), runtime
...
class WebcamPlugin(FeatureValidationPlugin):
    """Validates the EmpMonitor Webcam feature.

    Inherits every default from :class:`~plugins.base.FeatureValidationPlugin`.
    """

    feature_id = "EM020_Webcam"
    ...
    def feature_summary(self) -> Mapping[str, Any]:
        """Return detail specific to Webcam.
