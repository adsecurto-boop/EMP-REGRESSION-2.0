"""EM021_FaceDetection -- Face Detection validation plugin.

Validates the EmpMonitor Face Detection feature across configuration (L1), runtime
...
class FaceDetectionPlugin(FeatureValidationPlugin):
    """Validates the EmpMonitor Face Detection feature.

    Inherits every default from :class:`~plugins.base.FeatureValidationPlugin`.
    """

    feature_id = "EM021_FaceDetection"
    ...
    def feature_summary(self) -> Mapping[str, Any]:
        """Return detail specific to Face Detection.
