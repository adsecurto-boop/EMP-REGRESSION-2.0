"""EM022_Productivity -- Productivity validation plugin.

Validates the EmpMonitor Productivity feature across configuration (L1), runtime
...
class ProductivityPlugin(FeatureValidationPlugin):
    """Validates the EmpMonitor Productivity feature.

    Inherits every default from :class:`~plugins.base.FeatureValidationPlugin`.
    """

    feature_id = "EM022_Productivity"
    ...
    def feature_summary(self) -> Mapping[str, Any]:
        """Return detail specific to Productivity.
